...
services --enabled=dhcdbd,sshd,haldaemon,hddtemp,smartd,anacron,crond,atd,incron,avahi-daemon,named,ntpd,aiccu,messagebus,httpd,ejabberd,xinetd,pgsql-xs --disabled=pcscd,iptables,netfs,nfs,nfslock,rpcbind,rpcgssd,rpcidmapd,rpcsvcgssd,avahi-dnsconfd,radvd,ip6tables,dc_client,dc_server,squid,autofs,gpm,yum-updatesd,postgresql,dhcpd,exim,ntpdate
